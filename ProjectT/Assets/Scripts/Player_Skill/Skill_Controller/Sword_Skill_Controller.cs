...
public class Sword_Skill_Controller : MonoBehaviour
{
    ...
    private void BounceLogic()
    {
        ...
        {
            transform.position = Vector2.MoveTowards(transform.position, enemyTarget[targetIndex].position, bounceSpeed * Time.deltaTime); //≈∏∞Ÿ¿∏∑Œ √‚πﬂ

            if (Vector2.Distance(transform.position, enemyTarget[targetIndex].position) < .1f) //≈∏∞Ÿ¿∏∑Œ µµ¬¯»Æ¿Œ
            {
